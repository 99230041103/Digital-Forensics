...
```
📸  
![WhatsApp Image 2025-10-26 at 22 56 05_65118f3f](https://github.com/srihari2082005-ctrl/img-1/blob/81ac0b31aba2663010c931accca0028d612bae38/Screenshot%202025-10-27%20180809.png)
...
```bash
.\fsstat.exe -o 63 "C:\Users\Sri Hari\Downloads\4Dell Latitude CPi.E01"
```
🧾  
...
```bash
.\fls.exe -o 63 "C:\Users\Sri Hari\Downloads\4Dell Latitude CPi.E01"
...
```bash
.\icat.exe -o 63 "C:\Users\Sri Hari\Downloads\4Dell Latitude CPi.E01" 119 > "C:\Users\Sri Hari\Downloads\BOOTLOG_recovered.TXT"
```
🖼️  
![WhatsApp Image 2025-10-26 at 22 58 27_cffedd9f](https://github.com/srihari2082005-ctrl/img-1/blob/e36fc976b1d7d2612b959add4b7ee0c0e3b51cf6/Screenshot%202025-10-27%20180809.png)
...
```bash
.\istat.exe -o 63 "C:\Users\Sri Hari\Downloads\4Dell Latitude CPi.E01" 119 > "C:\Users\Sri Hari\Downloads\BOOTLOG_recovered.TXT" 
```
🧠  
